...
const Index = () => {
  ...
  let {data, loading, error, fetchData} = useFetch({url:`/skill/${id}`,method:"DELETE", body:null, token:token})
  ...
  const submit = (e) => {
    ...
    if (data) {
      ...
      alert ("La compétence a bien été supprimée !")
    }
    ...
    <>
      {
        isLogged && user.isAdmin === true ? (
          ...
          {
              isOpen && (
                <Modal title="Supprimer cette compétence" closeModal={()=>setIsOpen(false)}>
              ...
              <div className={styles.wrapper}>
                <div className={styles.deux_colonnes}>
                    <div className={styles.box_1}>
                        <Title Level="h1" title="Suppression de compétence"/>
